...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Beyond Your Imagination — Premium Digital Agency" },
      { name: "description", content: "Crafting the future of digital brands with premium web experiences powered by design, technology, and AI innovation." },
      { name: "author", content: "Beyond Your Imagination" },
      { property: "og:title", content: "Beyond Your Imagination — Premium Digital Agency" },
      { property: "og:description", content: "Crafting the future of digital brands with premium web experiences powered by design, technology, and AI innovation." },
